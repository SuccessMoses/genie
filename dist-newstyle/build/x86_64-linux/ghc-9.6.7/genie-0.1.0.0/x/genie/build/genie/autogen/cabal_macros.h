...
/* package genie-0.1.0.0 */
#ifndef VERSION_genie
#define VERSION_genie "0.1.0.0"
#endif /* VERSION_genie */
#ifndef MIN_VERSION_genie
#define MIN_VERSION_genie(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_genie */
...
#define CURRENT_COMPONENT_ID "genie-0.1.0.0-inplace-genie"
